        ...
        <div class="column">
          <div class="card">
            <div class="card-content">
              ...
              <p class="subtitle">- Classical Latin literature from 45 BC</p>
            </div>
          </div>
        </div>
        <div class="column">
...
export default {
  ...
  data() {
    return {
      heading: "Vue.js Demo",
      subheading:
        "Vue.js is an open-source, progressive JavaScript framework for building user interfaces and single-page applications.",
    };
  },
};
</script>
